...
main1:  mov ax,3        ;ф-я установки текстового видеорежима
        ...
        mov dh,60       ;x 1-го сообщения
        mov dl,11       ;y 1-го сообщения
        mov ah,16        ;цвет
        call printtext  ;вывести сообщение
        mov si,msg2     ;сообщение
        mov dh,67       ;x 2-го сообщения
        mov dl,12       ;y 2-го сообщения
        mov ah,12       ;цвет
        call printtext  ;вывести сообщение

        mov al,0dbh     ;код символа
        mov ah,5       ;цвет
        mov dh,9        ;начальный х фигуры
        mov dl,1        ;начальный y фигуры
        mov cx,10       ;сколько символов выводить по горизонтали
...
lp1:    call printchar  ;вывести символ
        ...
        pop cx
        sub dh,4        ;начало очередной строки на 4 символа влево
        add cx,8        ;в строке на 8 символов больше
        inc dl          ;перейти на следующую строку экрана
        cmp dl,3        ;пока не достигли заданной строки
        jnz lp2         ;продолжить
lp3:    push cx         ;сохранить регистры
        push dx
lp4:    call printchar  ;вывести символ
        inc dh          ;сдвинуться вправо
        loop lp4        ;вывести всю строку
        pop dx          ;восстановить регистры
        pop cx
        add dh,4        ;начало очередной строки на 4 символа вправо
        sub cx,8        ;в строке на 8 символов меньше
        inc dl          ;перейти на следующую строку экрана
        cmp dl,6        ;пока не достигли заданной строки
        jnz lp3         ;продолжить
